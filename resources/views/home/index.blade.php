    ...
    @if(auth()->user()->can('dashboard.data'))
        @if($is_admin)
    	   ...
    	   <div class="row">
    	    ...
    	    <!-- /.col -->
          	...
          	<div class="row">
				<div class="col-md-3 col-sm-12 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style" style="background: #00b09b;  /* fallback for old browsers */
                       ...
                       <span class="info-box-icon bg-red text-white">
                        ...
                        <div class="info-box-content">
                          <span class="info-box-text" style="color: white">{{ __('lang_v1.total_sell_return') }}</span>
                          <span class="info-box-number total_sell_return" style="color: white"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                        <!-- /.info-box-content -->
                        <p class="mb-0 text-muted fs-10 mt-5" style="color: white">{{ __('lang_v1.total_sell_return')}}: <span class="total_sr"></span><br>
                            {{ __('lang_v1.total_sell_return_paid')}}: <span class="total_srp"></span></p>
                    </div>
                  <!-- /.info-box -->
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style" style="background: #f12711;  /* fallback for old browsers */
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style" style="background: #c31432;  /* fallback for old browsers */
																	background: -webkit-linear-gradient(to right, #240b36, #c31432);  /* Chrome 10-25, Safari 5.1-6 */
																	background: linear-gradient(to right, #240b36, #c31432); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */">
                        <span class="info-box-icon bg-aqua"><i class="ion ion-ios-cart-outline"></i></span>

                        <div class="info-box-content">
                          <span class="info-box-text" style="color: white">{{ __('home.total_sell') }}</span>
                          <span class="info-box-number total_sell" style="color: white"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
                        </div>
                        <!-- /.info-box-content -->
                   </div>
                  <!-- /.info-box -->
                ...
                <!-- /.col -->
                <div class="col-md-3 col-sm-12 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style" style="background: #56ab2f;  /* fallback for old browsers */
                       ...
                       <span class="info-box-icon bg-red text-white">
                        ...
                        <!-- /.info-box-content -->
                         <p class="mb-0 text-muted fs-10 mt-5" style="color: white">{{ __('lang_v1.total_purchase_return')}}: <span class="total_pr"></span><br>
        ...
        @if(auth()->user()->can('sell.view') || auth()->user()->can('direct_sell.view'))
			@if(!empty($all_locations))
              	<div class="row">
              		<div class="col-sm-6">
						@component('components.widget', ['class' => 'box-primary', 'title' => __('home.accounting_overview_in_chart')])
