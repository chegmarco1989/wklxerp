...
<ul class="navbar-nav mb-1">
	<?php /* SYSTEME DE TRADUCTION BASE SUR "GTranslate.IO": */ ?>
	<li class="nav-item dropdown mx-1 my-2 my-lg-0" style="margin-top: 2px;">
		<div class="gtranslate_wrapper"></div>
		<script>window.gtranslateSettings = {"default_language":"en","native_language_names":true,"detect_browser_language":true,"url_structure":"sub_directory","wrapper_selector":".gtranslate_wrapper","flag_size":24,"horizontal_position":"left","vertical_position":"bottom","flag_style":"3d"}</script>
		<?php /*
	...
	<?php /* ICÔNE & LIEN DU "Retour" VERS L'ERP: */ ?>
    <li class="nav-item dropdown mx-1 my-2 my-lg-0">
        <a class="nav-link pt-1 pb-0" href="{{url('/home')}}">
    ...
    <li class="nav-item dropdown">
        <a id="user_nav_dp" href="#" class="dropdown-toggle nav-link pb-lg-0" data-toggle="dropdown" role="button" aria-expanded="false">
            <img class="rounded align-top my-n2 my-global-avatar" id="navProf_pic" height="33" width="35" src="{{messenger()->getProvider()->getProviderAvatarRoute()}}">
