...
<head>
    ...
    @endauth
    <?php /* <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.7.1/css/all.min.css"> */ ?>
...
<wrapper class="d-flex flex-column">
    <nav id="FS_navbar" class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark {{request()->is('messenger/*') && app('agent')->isMobile() ? 'NS' : ''}}">
        <a class="navbar-brand" href="{{url('/meet')}}">
            <?php /* <img src="{{ asset('vendor/messenger/images/messenger.png') }}" width="30" height="30" class="d-inline-block align-top" alt="Messenger">
            {{config('messenger-ui.site_name')}} */ ?>
			<img src="{{ asset('vendor/messenger/images/messenger.png') }}" width="190" height="40" class="d-inline-block align-top" alt="Worklx Meet">
        </a>
