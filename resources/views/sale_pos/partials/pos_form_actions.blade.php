...
<div class="row">
	<div class="pos-form-actions poscardcustom-3">
		<div class="col-md-12">
			@if($is_mobile)
			...
			<button type="button" class="pull-right btn btn-primary btn-flat @if($is_mobile) col-xs-6 @endif poscardcustom-4" data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions"> <i class="fas fa-clock"></i> @lang('lang_v1.recent_transactions')</button>
			@endif
