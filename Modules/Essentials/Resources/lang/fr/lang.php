...
return [
    ...
    'todo' => 'Tâches (à faire)',
    'todo_list' => 'Liste des tâches à exécuter',
    'task' => 'Tâche',
    ...
    'add_to_do' => 'Ajouter une tâche (à faire)',
    'edit_to_do' => 'Modifier une tâche (à faire)',
    'assign_todos' => "Attribuer une tâche (à faire) à d'autres",
    ...
    'set_sales_target' => 'Définir un objectif de ventes',
    'set_sales_target_for' => 'Définir un objectif de ventes pour :user',
    'total_sales_amount_from' => 'Montant total des ventes de',
    'total_sales_amount_to' => 'Montant total de la vente à',
    'commission_percent' => 'Commission en Pourcentage',
    'sales_target_commission' => "Commission de l'objectif de vente",
    'calculate_sales_target_commission_without_tax' => "Calculer l'objectif de vente Commission sans taxe",
    'calculate_sales_target_commission_without_tax_help' => "Si l'objectif de vente est coché, la commission sera calculée sur le total des ventes réalisées par l'employé, sans tenir compte des taxes.",
    'targets' => 'Objectifs',
    'target_achieved_this_month' => 'Objectif atteint ce mois-ci',
    'target_achieved_last_month' => 'Objectif atteint le mois dernier',
