                    ...
                    <li class="flex-grow-1">
                        <ul class="nav nav--lg-side flex-column-reverse flex-lg-row-reverse list-unstyled align-items-center p-0">
									...
									@if(Auth::check())
										<li class="hero-nav__item">
											<a href="{{ route('home') }}" class="hero-nav__link">
												<strong>
													<i class="fas fa-user-circle" style="letter-spacing: 3px;font-size: 19px;"></i> @lang('cms::lang.dashboard')
												</strong>
											</a>
										</li>
									@endif
										...
										@if(!Auth::check())
											<li class="hero-nav__item">
												<a href="{{ route('login') }}" class="hero-nav__link">
													<strong>
														<i class="fas fa-sign-in-alt" style="letter-spacing: 3px;"></i> @lang('lang_v1.login')
													</strong>
												</a>
											</li>
										@endif
                            ...
                            <li class="hero-nav__item dropdown">
								<a class="hero-nav__link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<span>
										<i class="fas fa-list" style="letter-spacing: 3px;"></i> 
										More
									</span>
								</a>
          						<ul class="dropdown-menu"  aria-labelledby="navbarDropdown">
            						<li><a class="dropdown-item" href="https://text.worklx.com" target="_blank">SMS Marketing Plateform</a></li>
            						<li><a class="dropdown-item" href="https://emm.worklx.tech" target="_blank">Email Marketing Plateform</a></li>
            					</ul>
							</li>
